...
const { storeCompanySchema, updateCompanySchema, idCompanySchema } = require('./middlewares/validations/companyValidation');
const { storeBranchSchema, updateBranchSchema, idBranchSchema } = require('./middlewares/validations/branchValidation');
const { storePermissionSchema, updatePermissionSchema, idPermissionSchema } = require('./middlewares/validations/permissionValidation');
const { storeWorkerSchema, updateWorkerSchema, idWorkerSchema } = require('./middlewares/validations/workerValidation');
const { storeBranchWorkerSchema, updateBranchWorkerSchema, idBranchWorkerSchema, typeRoleBranchSchema } = require('./middlewares/validations/branchworkerValidation');
const { storePermissionRoleSchema, updatePermissionRoleSchema, idPermissionRoleSchema, role_idRoleSchema } = require('./middlewares/validations/permissionroleValidation');
...
router.post('/login-apk', validateSchema(loginSchema), AuthController.login_apk);
...
router.post('/branch-routes', validateSchema(branch_idTripSchema), BranchRouteController.branch_routes);
...
router.post('/ticket', validateSchema(storeTicketSchema), TicketController.store);
...
router.post('/ticket-tuus', validateSchema(idTicketSchema), TuuController.getPaymentsByTicketId);
...
router.post('/structure-destroy', validateSchema(idStructureSchema), StructureController.destroy);
